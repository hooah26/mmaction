...
- An Example of TSN
  ...
  train_pipeline = [  # Training data processing pipeline
      dict(  # Config of SampleFrames
          ...
          clip_len=1,  # Frames of each sampled src clip
...
- An Example of FastRCNN
  ...
  train_pipeline = [  # Training data processing pipeline
      dict(  # Config of SampleFrames
          ...
          clip_len=4,  # Frames of each sampled src clip
...
- An Example of BMN
  ...
  val_evaluator = dict(
    type='ANetMetric',
    metric_type='AR@AN',
    dump_config=dict(  # Config of localization src
        out=f'{work_dir}/results.json',  # Path to the src file
        output_format='json'))  # File format of the src file
