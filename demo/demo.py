...
def parse_args():
    ...
    parser.add_argument(
        ...
        default=30,
        type=int,
        help='specify fps value of the src video when using rawframes to '
        'generate file')
    parser.add_argument(
        '--font-scale',
        default=None,
        type=float,
        help='font scale of the text in src video')
    parser.add_argument(
        '--font-color',
        default='white',
        help='font color of the text in src video')
    parser.add_argument(
        '--target-resolution',
        nargs=2,
        default=None,
    ...
    parser.add_argument('--out-filename', default=None, help='src filename')
