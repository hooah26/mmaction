...
try:
    ...
    raise ImportError('Please install moviepy to enable src file')
...
def parse_args():
    ...
    parser.add_argument('out_filename', help='src filename')
    parser.add_argument(
        '--config',
        default=('configs/detection/acrn/ava21.py'),
    ...
    parser.add_argument(
        ...
        default=6,
        type=int,
        help='the fps of demo video src')
    parser.add_argument(
        '--cfg-options',
        nargs='+',
        action=DictAction,
