...
def parse_args():
    ...
    parser.add_argument(
        'output_dir', default=None, type=str, help='src directory')
    ...
    parser.add_argument(
        ...
        'means show images stitched by "original" and "src" images. '
    ...
    parser.add_argument(
        ...
        '-r',
        type=float,
        help='video rescale factor, which is useful if the src is too '
        'large or too small.')
    parser.add_argument(
        '--cfg-options',
        nargs='+',
