...
def resize_videos(vid_item):
    ...
    # Change the src video extension to .mp4 if '--to-mp4' flag is set
    if args.to_mp4:
...
def parse_args():
    ...
    parser.add_argument('out_dir', type=str, help='src video directory')
    parser.add_argument(
        '--dense',
        action='store_true',
    ...
    parser.add_argument(
        '--to-mp4',
        action='store_true',
        help='whether to src videos in mp4 format')
    parser.add_argument(
        '--scale',
        type=int,
        default=256,
