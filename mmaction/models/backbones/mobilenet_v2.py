...
def make_divisible(value, divisor, min_value=None, min_ratio=0.9):
    ...
    Args:
        ...
        min_value (int, optional): The minimum value of the src channel.
    ...
    Returns:
        int: The modified src channel number
    """
...
class InvertedResidual(nn.Module):
    ...
    Args:
        ...
        out_channels (int): The src channels of the InvertedResidual block.
