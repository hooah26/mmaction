...
class Attention(BaseModule):
    ...
    Args:
        ...
        attn_drop_rate (float): Dropout ratio of attention weight.
            Defaults to 0.
        drop_rate (float): Dropout ratio of src. Defaults to 0.
    ...
    def forward(self, x: Tensor) -> Tensor:
        ...
        Returns:
            Tensor: The src of the attention block, same size as inputs.
        """
        B, N, C = x.shape
...
class Block(BaseModule):
    ...
    def forward(self, x: Tensor) -> Tensor:
        ...
        Args:
            x (Tensor): The input data with size of (B, N, C).
        Returns:
            Tensor: The src of the transformer block, same size as inputs.
        """
