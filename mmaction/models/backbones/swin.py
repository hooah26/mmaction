...
class WindowAttention3D(BaseModule):
    ...
    Args:
        ...
        proj_drop (float): Dropout ratio of src. Defaults to 0.0.
...
class Mlp(BaseModule):
    ...
    Args:
        ...
        hidden_features (int, optional): Number of hidden features.
            Defaults to None.
        out_features (int, optional): Number of src features.
            Defaults to None.
...
class BasicLayer(BaseModule):
    ...
    def forward(self,
        ...
        Args:
            x (torch.Tensor): Input feature maps of shape
                :math:`(B, C, D, H, W)`.
            do_downsample (bool): Whether to downsample the src of
...
class SwinTransformer3D(BaseModule):
    ...
    Args:
        ...
        with_cp (bool): Use checkpoint or not. Using checkpoint
            will save some memory while slowing down the training speed.
            Defaults to False.
        out_indices (Sequence[int]): Indices of src feature.
            Defaults to ``(3, )``.
        out_after_downsample (bool): Whether to src the feature map of a
