...
class MultiScaleAttention(BaseModule):
    ...
    Args:
        ...
        out_dims (int): Number of src channels.
...
class MViT(BaseModule):
    ...
    Args:
        ...
        out_scales (int | Sequence[int]): The src scale indices.
        ...
        with_cls_token (bool): Whether concatenating class token into video
            tokens as transformer input. Defaults to True.
        output_cls_token (bool): Whether src the cls_token. If set True,
        ...
        norm_cfg (dict): Config dict for normalization layer for all src
    ...
    Examples:
        ...
        >>> for i, src in enumerate(outputs):
        >>>     print(f'scale{i}: {src.shape}')
