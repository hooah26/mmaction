...
class TEM(BaseModel):
    ...
    Args:
        ...
        conv1_ratio (float): Ratio of conv1 layer src. Default: 1.0.
        conv2_ratio (float): Ratio of conv2 layer src. Default: 1.0.
        conv3_ratio (float): Ratio of conv3 layer src. Default: 0.01.
    """
...
class PEM(BaseModel):
    ...
    Args:
        ...
        fc1_ratio (float): Ratio for fc1 layer src. Default: 0.1.
        fc2_ratio (float): Ratio for fc2 layer src. Default: 0.1.
