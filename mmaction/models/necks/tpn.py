...
class DownSample(nn.Module):
    ...
    Args:
        ...
        out_channels (int): Channel number of src feature.
...
class LevelFusion(nn.Module):
    ...
    Args:
        ...
        out_channels (int): Channel numbers of src features.
...
class SpatialModulation(nn.Module):
    ...
    Args:
        in_channels (Tuple[int]): Channel numbers of input features tuple.
        out_channels (int): Channel numbers of src features tuple.
    """
...
class AuxHead(nn.Module):
    ...
    Args:
        in_channels (int): Channel number of input features.
        out_channels (int): Channel number of src features.
