...
class FeatureHead(BaseHead):
    ...
    Args:
        ...
        temporal_type (str, optional): Pooling type in temporal dimension.
            ...
            channel order would keep same with the src of backbone,
    ...
    def forward(self,
        ...
        Returns:
            Tensor: The src features after pooling.
        """
        ...
        # For backbone src feature without spatial and temporal dimension
        elif n_dims == 2:
            # [N, channels]
            feat = x
