...
class RandomCrop(BaseTransform):
    """Vanilla square random crop that specifics the src size.
    ...
    Args:
        size (int): The src size of the images.
        lazy (bool): Determine whether to apply lazy operation. Default: False.
    """
...
class RandomResizedCrop(RandomCrop):
    ...
    Args:
        area_range (Tuple[float]): The candidate area scales range of
            src cropped images. Default: (0.08, 1.0).
        aspect_ratio_range (Tuple[float]): The candidate aspect ratio range of
            src cropped images. Default: (3 / 4, 4 / 3).
        lazy (bool): Determine whether to apply lazy operation. Default: False.
    """
    ...
    def get_crop_bbox(img_shape,
        ...
        Args:
            ...
            aspect_ratio_range (Tuple[float]): The candidate aspect
                ratio range of src cropped images. Default: (3 / 4, 4 / 3).
...
class Resize(BaseTransform):
    ...
    Args:
        scale (float | Tuple[int]): If keep_ratio is True, it serves as scaling
            ...
            Otherwise, it serves as (w, h) of src size.
